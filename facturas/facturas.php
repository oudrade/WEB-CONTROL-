        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="facturas/editar.php?id=<?= $index ?>"><button>Editar</button></a>
                        <a href="facturas/eliminar.php?id=<?= $index ?>" onclick="return confirm('¿Eliminar esta factura?')"><button>Eliminar</button></a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
